    ...
    return declare("gaodeLayer", TiledMapServiceLayer, {
        ...
        getTileUrl: function (level, row, col) {
            ...
            switch (this.layertype) {
                case "road":
                    url = 'http://webrd0' + (col % 4 + 1) + '.is.autonavi.com/appmaptile?mapType=blue_night&lang=zh_cn&size=1&scale=1&style=8&x=' + col + '&y=' + row + '&z=' + level+'&mapType=blue_night';
                    break;
                case "st":
                ...
                case "label":
                    ...
                    break;
                default:
                    url = 'http://webrd0' + (col % 4 + 1) + '.is.autonavi.com/appmaptile?lang=zh_cn&size=1&scale=1&style=5&x=' + col + '&y=' + row + '&z=' + level+'&mapType=blue_night';
                    break;
            }
            console.log(this.layertype,url);
            return url;
        }
    });
});